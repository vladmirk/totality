...
public class AccService {
    ...
    public Map<Game, Long> countBetsPerTournament(Tournament tournament) {
        Map<Game, Long> map = new HashMap<>();
        List<BetsPerGame> betsPerGames = betRepository.countBetsPerGame(tournament);
        for (BetsPerGame bets : betsPerGames)
            map.put(bets.getGame(), bets.getQnty());
        return map;
    }
