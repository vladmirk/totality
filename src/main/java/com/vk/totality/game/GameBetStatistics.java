...
public class GameBetStatistics {
    ...
    public GameBetStatistics() {
    }

    public GameBetStatistics(Integer betCount, Long betFilledCount) {
        this.betCount = betCount;
        this.betFilledCount = betFilledCount == null ? 0 : Math.toIntExact(betFilledCount);
    }
